const works = [
  {
    ...
    description:
      "학교 졸업프로젝트로 진행한 프로젝트. 재밌는 시점을 언급한 인기댓글을 모아 하이라이트를 만들어 보여준다.",
    createdYear: "2020년",
  ...
  },
  {
    ...
    description:
      "ReactJS를 익히기 위해 NomadCoder 강의를 보며 따라 만들어보았다.",
    createdYear: "2020년",
  ...
  },
  {
    ...
    description:
      "QR코드를 찍으면 모바일 컨트롤러가 나타난다. 터치패드, 키보드 조작하듯 웹소켓 통신으로 원격 제어하도록 만들었다.",
    createdYear: "2020년",
  ...
  },
  {
    ...
    description:
      "단순히 내가 여행을 좋아해서 만들게되었다. 다녀온 나라를 iOS Today 위젯을 띄울 수 있다.",
    createdYear: "2020년",
  ...
  },
  {
    ...
    description:
      "왜 요리 레시피는 전문적인 셰프들만 작성하는걸까? 생활 속 나만의 요리책도 공유할 수 있지 않을까?",
    createdYear: "2013년",
  ...
  },
  {
    ...
    description:
      "SK STAC 팀 프로젝트로 개발했던 것을 PC버전으로 다시 만들어본 손 쉽게 마인드맵을 그리는 프로그램. XML형식 파일로 내보내고 불러올 수 있다.",
    createdYear: "2012년",
    tags: [
      "베지어 곡선",
      "Adobe AIR",
  ...
  },
  {
    ...
    description:
      "고등학교 입학 후 첫 공모전 입상 작품이자 첫 팀프로젝트 작품. GitHub, REST API 등 모르던 것들을 많이 배울 수 있었다.",
    createdYear: "2012년",
    tags: [
      "베지어 곡선",
      "Adobe AIR",
  ...
  },
  {
    ...
    description:
      "마이크로소프트 키넥트를 활용하여 여러 프로그램을 만들어보았다. 기록이 많이 날아갔지만..",
    createdYear: "2012년",
  ...
  },
  {
    ...
    description:
      "플래시 IDE로 게임 개발하는게 너무 익숙해서 최대한 비슷하게 게임라이브러리를 만들어보고자했다. 완벽하지 않지만 화면 렌더링용으로 그냥 그럭저럭 쓸만했다.",
    createdYear: "2012년",
  ...
  },
  {
    ...
    description:
      "모바일 앱이 처음 등장할 무렵, 비공식적으로 만든 교내 인트라넷 앱. 기상송 신청, 잔류 확인, 급식 평가 등 기능이 있었다.",
    createdYear: "2012년",
    tags: [
      "교내 앱 개발",
      "Adobe AIR",
  ...
  },
  {
    ...
    description:
      "처음으로 만들어본 안드로이드 게임. 구리지만 스마트폰 초창기라 많이들 즐겨주셨다.",
    createdYear: "2012년",
  ...
  },
  {
    ...
    description:
      "기존 CPU 단에서 렌더링하여 그래픽처리 속도가 느렸던 플래시게임을 위해 GPU를 사용하여 그림을 그리도록 돕는 라이브러리를 만들었다.",
    createdYear: "2011년",
  ...
  },
  {
    ...
    description:
      "AS3.0 내 OpenGL처럼 GPU 가속 렌더링을 도와주는 Molehill API를 활용한 3D 두더지 잡기 게임",
    createdYear: "2011년",
